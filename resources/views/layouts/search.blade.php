...
<body>
    ...
    <footer class=" body-font px-[12%] bg-[#5f5f5f]">
        <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <span class="ml-3 text-2xl text-white font-semibold">Melodies</span>
            </a>
            <p class="text-sm text-white sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2021 FantasticFive
            </p>
